...
import { Sparkles, Utensils, ArrowRight, Dumbbell, Users } from "lucide-react";
    ...
    <div className="flex-1 w-full bg-background flex flex-col items-center">
      ...
      <section className="w-full flex flex-col items-center justify-center text-center px-4 py-32 md:py-48 relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md justify-center">
          <Link to="/exercise/recommend" className="flex items-center justify-center gap-2 bg-neon-400 text-black px-8 py-4 rounded-xl font-bold text-lg hover:bg-neon-500 transition-colors w-full sm:w-auto">
            AI 루틴 추천받기 <ArrowRight size={20} />
          </Link>
          <Link to="/community" className="flex items-center justify-center gap-2 bg-zinc-900 border border-zinc-800 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-zinc-800 hover:border-zinc-700 transition-colors w-full sm:w-auto">
            커뮤니티 둘러보기
          </Link>
        </div>
      </section>
      ...
      <section className="w-full max-w-6xl px-4 py-24 border-t border-zinc-800/50">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <Link to="/exercise/recommend" className="group p-8 rounded-3xl border border-zinc-800 bg-zinc-900/30 hover:bg-zinc-900/80 transition-all text-left">
          ...
          {/* Feature 2 */}
          <Link to="/meal/add" className="group p-8 rounded-3xl border border-zinc-800 bg-zinc-900/30 hover:bg-zinc-900/80 transition-all text-left">
            <div className="w-14 h-14 bg-black border border-zinc-800 rounded-2xl flex items-center justify-center text-neon-400 mb-6 group-hover:scale-110 transition-transform">
              <Utensils size={28} />
            </div>
          ...
          {/* Feature 3 */}
          <Link to="/community" className="group p-8 rounded-3xl border border-zinc-800 bg-zinc-900/30 hover:bg-zinc-900/80 transition-all text-left">
            <div className="w-14 h-14 bg-black border border-zinc-800 rounded-2xl flex items-center justify-center text-neon-400 mb-6 group-hover:scale-110 transition-transform">
              <Users size={28} />
            </div>
